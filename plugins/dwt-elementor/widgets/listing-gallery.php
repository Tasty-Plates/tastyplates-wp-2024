...
class Listing_Gallery extends Widget_Base
{
    ...
    {
        return __('Listing Gallery', 'dwt-elementor');
    }
    ...
    protected function render()
    {
        ...
        echo dwt_elementor_listing_gallery($params);
    }
    /**
