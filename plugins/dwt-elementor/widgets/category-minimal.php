...
use Elementor\Controls_Manager;
 ...
 class Category_Minimal extends Widget_Base {
    public function get_name()
    {
        return 'categories-minimal';
    }

    public function get_title()
    {
        return __('Categories(Minimal)', 'dwt-elementor');
    }
    ...
    protected function render()
    {
        ...
        echo dwt_elementor_category_minimal($params);
    }
    /**
