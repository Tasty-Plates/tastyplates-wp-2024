...
if (!class_exists('ReduxFramework_extension_wbc_importer')) {
        ...
        public function getImports() {
            ...
            if (!empty($imports) && is_array($imports)) {
                ...
                foreach ($imports as $import) {
                    ...
                    /**
                     * work for elementor page builder
                     */
                    if (strpos($import['name'], 'Elementor') !== false) {
                        ...
                        /**
                         * check Wpbakery is installed or not
                         */
    ...
    if (!function_exists('wbc_after_theme_options')) {
        ...
        function wbc_after_theme_options($demo_active_import, $demo_data_directory_path) {
            ...
            if (get_option('dwt_listing_fresh_installation') == 'yes') {
                global $wpdb;
                ...
                dwt_listing_importing_data($current_demo);
                update_option('dwt_listing_fresh_installation', 'no');
            }


            /*
             * elementors is active
             * then set menu and pages
             */
            if (is_plugin_active('elementor/elementor.php')) {

                if ($current_demo == 'Elementor Directory & Listing') {
                    $home_title = 'Elegant Home';
                }
                ...
                $menu_name = "DWT Listing Main Menu";
                ...
                wp_update_nav_menu_item($menu_id, 0, array(
                    ...
                    'menu-item-classes' => 'listing-search',
                    'menu-item-url' => home_url('/listing-search/'),
                    'menu-item-status' => 'publish'
                ));

                wp_update_nav_menu_item($menu_id, 0, array(
                    'menu-item-title' => __('Packages'),
                    'menu-item-classes' => 'packages',
                    'menu-item-url' => home_url('/packages/'),
                    'menu-item-status' => 'publish'
                ));
                ...
                wp_update_nav_menu_item($menu_id, 0, array(
                    ...
                    'menu-item-classes' => 'events-search',
                    'menu-item-url' => home_url('/events-search'),
                    'menu-item-status' => 'publish',
                    'menu-item-parent-id' => $submenu
                ));
                ...
                wp_update_nav_menu_item($menu_id, 0, array(
                    'menu-item-title' => __('Theme Icons'),
                    'menu-item-classes' => 'theme-icons',
                    'menu-item-url' => home_url('/theme-icons'),
                    'menu-item-status' => 'publish',
                    'menu-item-parent-id' => $submenu
                ));
                ...
                wp_update_nav_menu_item($menu_id, 0, array(
                    ...
                    'menu-item-classes' => 'privacy-policy-2',
                    'menu-item-url' => home_url('/privacy-policy-2/'),
                    'menu-item-status' => 'publish'
                ));
                ...
                /*RTL of Wp-Backery*/
                if ($current_demo == 'RTL') {
                    $home = get_page_by_title('Elegant Home');
                    update_option('page_on_front', $home->ID);
                    update_option('show_on_front', 'page');
                    ...
                    /*WP-Backery*/
                    if ($current_demo == 'Directory & Listing' || $current_demo == 'Salon' || $current_demo == 'Pets' || $current_demo == 'Autos' || $current_demo == 'EduPro' || $current_demo == 'Royal' || $current_demo == 'Gadgets') {
                        $home_title = 'Elegant Home';
                    }
                    if ($current_demo == 'Shanghai') {
                        $home_title = 'Shanghai Zone';
                    }
                    if ($current_demo == 'Events') {
                        $home_title = 'Bangkok Events';
                    }
                    if ($current_demo == 'Shop') {
                        $home_title = 'Singapore Shops';
                    }
                    if ($current_demo == 'Lahore') {
                        $home_title = 'Lahori Hub';
                    }
                    if ($current_demo == 'Los Angeles') {
                        $home_title = 'Los Angeles Hub';
                    }
