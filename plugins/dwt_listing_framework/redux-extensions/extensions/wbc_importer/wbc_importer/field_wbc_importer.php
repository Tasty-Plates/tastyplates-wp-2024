    ...
    class ReduxFramework_wbc_importer {
        ...
        function __construct( $field = array(), $value ='', $parent='' ) {
            ...
            if ( !empty( $class->demo_data_dir ) ) {
              ...
              $this->demo_data_url = str_replace( "wbc_importer/wbc_importer/", "wbc_importer/", plugin_dir_url( __FILE__ )) . 'demo-data/';
              //echo str_replace( "wbc_importer/wbc_importer/", "wbc_importer/", plugin_dir_url( __FILE__ )) . 'demo-data/';
            }
