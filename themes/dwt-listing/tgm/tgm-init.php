...
function dwt_listing_themes_register_required_plugins()
{
    ...
    if (!is_plugin_active('js_composer/js_composer.php')) {
        $elementor_plugin = array(
            ...
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/elementor.3.6.6.zip'), // If set, overrides default API URL and points to an external URL.
    ...
    $plugins = array(
        ...
        array(
            ...
            'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.   
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/woocommerce.6.6.1.zip'
        ...
        array(
            ...
            'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.   
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/redux-framework.4.3.15.zip'
            ), // If set, overrides default API URL and points to an external URL.
            'is_callable' => '', // If set, this callable will be be checked for availability to determine if a plugin is active.
        ),
        array(
            ...
            'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.    
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/contact-form-7.5.5.6.1.zip'), // If set, overrides default API URL and points to an external URL.
            'is_callable' => '', // If set, this callable will be be checked for availability to determine if a plugin is active.
        ),
        array(
            ...
            'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.    
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/post-views-counter.1.3.11.zip'), // If set, overrides default API URL and points to an external URL.
            'is_callable' => '', // If set, this callable will be be checked for availability to determine if a plugin is active.
        ),
    );
