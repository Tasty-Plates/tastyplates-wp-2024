...
Redux::set_section($opt_name, array(
    'title' => __('Users Settings', 'dwt-listing'),
    'id' => 'users-settings',
    'desc' => __('Here you can setup the users settings', 'dwt-listing'),
    'customizer_width' => '400px',
    'icon' => 'el el-user',
    'fields' => array(
        array(
            
            'id' => 'dwt_listing_booking_time_kit',
            'type' => 'switch',
            'title' => __('Booking With Time Kit', 'dwt-listing'),
            'default' => false,
            'desc' => __('Booking with timekit.io', 'dwt-listing'),
        ),
        array(
            'id' => 'dwt_listing_booking_reservation',
            'type' => 'switch',
            'title' => __('Make a Custom Booking/Reservation', 'dwt-listing'),
            'default' => false,
            'desc' => __('Please turn time kit booking off to make custom booking on', 'dwt-listing'),
            'required' => array('dwt_listing_booking_time_kit', '!=', array('1')),
        ),
        array(
        ...
        array(
            ...
            'data' => 'pages',
            'multi' => false,
            'title' => __('Author Dashboard', 'dwt-listing'),
        ...
        array(
            ...
            'default' => array('url' => trailingslashit(get_template_directory_uri()) . 'assets/images/users/defualt.jpg'),
        ),
        array(
            'id' => 'users_per_page',
            'type' => 'spinner',
            'title' => __('All Authors', 'dwt-listing'),
            'subtitle' => __('per page', 'dwt-listing'),
            'default' => '12',
            'min' => '1',
            'step' => '1',
            'max' => '100',
