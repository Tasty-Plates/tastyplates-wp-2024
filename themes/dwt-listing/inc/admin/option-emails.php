...
&nbsp;',
       ...
       /* array(
        ...
        array(
            ...
            'desc' => esc_html__('%site_name% , %ad_owner% , %ad_title% , %ad_link%, %report_reason% will be translated accordingly.', 'dwt-listing'),
            'default' => '<table class="body" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f6f6f6; width: 100%;" border="0" cellspacing="0" cellpadding="0">
<tbody>
<tr>
<td style="font-family: sans-serif; font-size: 14px; vertical-align: top;"></td>
...
<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Title: %ad_title%</p>
<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Reason: %report_reason%</p>
<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Link: <a href="%ad_link%">%ad_title%</a></p>
...
&nbsp;',
        ...
        //bookig approved status subject
        array(
            'id' => 'dwt_listing_booking_approved_subject',
            'type' => 'text',
            'title' => __('Your Booking has been Approved', 'dwt-listing'),
            'desc' => __('%site_name% will be translated accordingly.', 'dwt-listing'),
            'default' => 'Listing Approved - DWT Listing',
        ),
        array(
            'id' => 'dwt_listing_booking_status_approved_message',
            'type' => 'editor',
            'title' => esc_html__('Booking Approved Email', 'dwt-listing'),
            'args' => array(
                'teeny' => true,
                'textarea_rows' => 10,
                'wpautop' => false,
            ),
            'desc' => esc_html__('%site_name% , %user%  will be translated accordingly.', 'dwt-listing'),
            'default' => '<table class="body" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f6f6f6; width: 100%;" border="0" cellspacing="0" cellpadding="0">
<tbody>
<tr>
<td style="font-family: sans-serif; font-size: 14px; vertical-align: top;"></td>
...
&nbsp;',
        ...
        array(
            'id' => 'dwt_listing_booking_rejected_subject',
            'type' => 'text',
            'title' => __('Your Booking has been Rejected', 'dwt-listing'),
            'desc' => __('%site_name% will be translated accordingly.', 'dwt-listing'),
            'default' => 'Listing Approved - DWT Listing',
        ),
        ...
        array(
            ...
            'id' => 'dwt_listing_booking_status_rejected_message',
            'type' => 'editor',
            'title' => esc_html__('Booking Rejected Email', 'dwt-listing'),
            'args' => array(
                'teeny' => true,
                'textarea_rows' => 10,
                'wpautop' => false,
...
&nbsp;',
        ...
        array(
            ...
            'type' => 'text',
            'title' => esc_html__('Listing Claim Email FROM', 'dwt-listing'),
            'desc' => esc_html__('FROM: NAME valid@email.com is compulsory as we gave in default.', 'dwt-listing'),
            'default' => 'From: ' . get_bloginfo('name') . ' <' . get_option('admin_email') . '>',
        ),
        array(
            ...
            'type' => 'editor',
            'title' => esc_html__('Listing Claim Template', 'dwt-listing'),
            'args' => array(
                'teeny' => true,
                'textarea_rows' => 10,
                'wpautop' => false,
