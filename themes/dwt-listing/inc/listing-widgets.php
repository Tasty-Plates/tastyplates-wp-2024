        ...
        <div class="utf_box_widget reservation_section">
            <div class="reservation-form">
                <div class="reservation-head">
                        ...
                        <h3><?php echo esc_html__( 'Billing Information', 'dwt-listing' ); ?> </h3>
                        </div>
                    </div>
                    <div class="reservation-form-body">
                        <form id="reservation_information">
                            <div class="form-group">
                                ...
                                <input name="reserver_name" required class="form-control" type="text" id="inputfirstname" autocomplete="off" placeholder="Your Name">
                            </div>
                            <div class="form-group">
                                <label for="inputmobnumber">Mobile Number</label>
                                <input name="reserver_number" required class="form-control" type="number" id="inputmobnumber" autocomplete="off"  placeholder="Mobile Number">
                            </div>
                            ...
                            <button class="btn btn-primary" id="submit_reservation">Submit</button>
                            <button class="btn btn-primary" type="button" id="cancel_reservation">Cancel</button>
                            <?php }?>
                        </form>
                    </div>
                </div>
            ...
            if (get_post_meta($listing_id, 'dwt_listing_is_hours_allow', true) == 1) {
                    ...
                    <form id="hotel_reservation_form" class="reserve_my_table"> 
                        <h4>
                            <div class="booking-icon">
                                <i class="fa fa-calendar"></i>  <?php echo esc_html__( 'Book an Appointment', 'dwt-listing' ); ?>
                            </div>
                            <div class="price">
                                ...
                                <div class="selected_options" id="booking_time">
                                    <select class="form-select form-select-time-slot" id="form_select_timeslot" name="select_time_slot"  aria-label="Default select example">
                                       <option selected> Select a Time Slot</option>
                                        <option><strong>  2:00 AM -  2:30 AM    </strong></option>
                                        <option><strong>  3:00 AM -  3:30 AM    </strong></option>
                                        <option><strong>  4:00 AM -  4:30 AM    </strong></option>
                                        <option><strong>  5:00 AM -  5:30 AM    </strong></option>
                                        <option><strong>  6:00 AM -  6:30 AM    </strong></option>
                                        <option><strong>  7:00 AM -  7:30 AM    </strong></option>
                                        <option><strong>  8:00 AM -  8:30 AM    </strong></option>
                                        <option><strong>  9:00 AM -  9:30 AM    </strong></option>
                                        <option><strong>  10:00 AM - 10:30 AM   </strong></option>
                                        <option><strong>  11:00 PM - 11:30 PM   </strong></option>
                                        <option><strong>  12:00 PM - 12:30 PM   </strong></option>
                                        <option><strong>  1:00 PM - 1:30 PM     </strong></option>
                                        <option><strong>  2:00 PM - 2:30 PM     </strong></option>
                                        <option><strong>  3:00 PM - 3:30 PM     </strong></option>
                                        <option><strong>  4:00 PM - 4:30 PM     </strong></option>
                                        <option><strong>  5:00 PM - 5:30 PM     </strong></option>
                                        <option><strong>  6:00 PM - 6:30 PM     </strong></option>
                                        <option><strong>  7:00 PM - 7:30 PM     </strong></option>
                                        <option><strong>  8:00 PM - 8:30 PM     </strong></option>
                                        <option><strong>  9:00 PM - 9:30 PM     </strong></option>
                                        <option><strong>  10:00 PM - 10:30 PM   </strong></option>
                                        <option><strong>  11:00 PM - 11:30 PM   </strong></option>
                                        <option><strong>  11:30 PM - 00:00 AM   </strong></option>

                                    </select>
                                    <div class="closed_day none">
                                        <h4>Selected Day is Closed!</h4>
                                    </div>
                                </div>
                            <div>
             ...
             <?php }else{
                echo '<h3>' . "No Business Hours Available For Reservation" .'</h3>' ;
            }
        }
?>
