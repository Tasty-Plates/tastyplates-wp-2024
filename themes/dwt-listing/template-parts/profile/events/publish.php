        ...
        <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title"><?php echo esc_html__('Published Events', 'dwt-listing'); ?></h3>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="action-icons active">
                                                    <?php
                                                    $event_publish_edit_url = dwt_listing_set_url_params_multi($permalink, array('listing-type'=> 'create-events', 'edit_event'=> esc_attr($event_id)));
                                                    ?>
                                                    <a class="tool-tip" title="<?php echo esc_attr__('Edit', 'dwt-listing'); ?>" href="<?php echo esc_url(dwt_listing_page_lang_url_callback($event_publish_edit_url)); ?>"><i class="ti-pencil-alt"></i></a>
                                                    <?php
                                                    if (dwt_listing_text('dwt_listing_disable_edit') == '1' && !is_super_admin(get_current_user_id())) {
                                                        ...
                                                        <a class="tool-tip expire-my-events" title="<?php echo esc_attr__('Expired', 'dwt-listing'); ?>" href="javascript:void(0)" data-myevent-id="<?php echo esc_attr($event_id); ?>"><i class="ti-alert text-warning"></i></a>
