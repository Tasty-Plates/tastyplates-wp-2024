            ...
            <form class="review-form-listing" method="get" enctype="multipart/form-data" data-disable="false">
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    if (dwt_listing_text('dwt_listing_disable_edit') == '1' && !is_super_admin(get_current_user_id())) {
                        ...
                        ?>
                        <button type="submit" class="btn <?php echo esc_attr($btn_class); ?> sonu-button-review" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo esc_html__("Processing...", 'dwt-listing'); ?>"><?php echo esc_html__("Submit Review", 'dwt-listing'); ?></button>
                    <?php } ?>
                </div>
            </form>
        </div>
