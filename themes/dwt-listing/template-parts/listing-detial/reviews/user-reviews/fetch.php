                                        ...
                                        foreach ($media as $m) {
                                            ...
                                            if ($counter < 5) {
                                                ...
                                                <span class="review-img-container">
                                                    <a href="<?php echo esc_url($full_img[0]); ?>" data-fancybox="images-preview-<?php echo '' . $comment->comment_ID; ?>"> <img src="<?php echo esc_url($thumb_imgs[0]); ?>" class="img-responsive" alt="image" /><?php echo '' . $my_class; ?></a>
                                                </span>
                                                <?php
                                            } else {
                                                ?>
                                            <div class="hidden">
                                                <a href="<?php echo esc_url($full_img[0]); ?>" data-fancybox="images-preview-<?php echo '' . $comment->comment_ID; ?>"> <img src="<?php echo esc_url($thumb_imgs[0]); ?>" class="img-responsive" alt="image" /> </a>
                                            </div>
                                            <?php
                                        }
                                        $counter++;
