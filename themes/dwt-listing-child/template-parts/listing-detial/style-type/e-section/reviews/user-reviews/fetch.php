    ...
    <div class="reviews">
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12 col-sm-12">
                    <div class="review-title">
                        <h3><?php echo esc_html__('Reviews', 'dwt-listing'); ?></h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        ?>
            <div class="review-box">
                <div class="review-author-left testjanin">
                    ...
                    <div class="reviewer-category">
                            <?php get_field('cs_user_location', $comment->user_id); ?>
                            <?php
                            $locations = get_field('taste_palette', 'user_' . $comment->user_id);

                            if ($locations) : ?>
                                <div class="cs-palate"><?php echo implode(', ', $locations); ?></div>
                            <?php endif; ?>
<!--
                ...
                <a target="_blank" href="<?php echo esc_url($commenter_profile_url); ?>">
                <strong><?php echo esc_attr($comment->comment_author); ?></strong> </a>
                <span class="sr-review"> <?php echo date_i18n('j F, Y', strtotime(get_the_time($comment->comment_date))); ?></span>
                                    ...
                                    <p class="image-gallery">
                                        ...
                                        ?>
                                                <span class="review-img-container">
                                                    <a href="<?php echo $full_img; ?>" data-fancybox="images-preview-<?php echo '' . $comment->comment_ID; ?>"> <img src="<?php echo $full_img; ?>" class="img-responsive" alt="image" /><?php echo '' . $my_class; ?></a>
                                                </span>
                                            <?php
                                            } else {
                                            ?>
                                    <div class="hidden">
                                        <a href="<?php echo $full_img; ?>" data-fancybox="images-preview-<?php echo '' . $comment->comment_ID; ?>"> <img src="<?php echo $full_img; ?>" class="img-responsive" alt="image" /> </a>
                                    </div>
                        <?php
                                            }
                                            $counter++;
